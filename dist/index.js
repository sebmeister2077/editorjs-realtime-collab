...
class GroupCollab {
    ...
    getRedactor() {
        ...
        if (holder) {
            ...
            if (redactorInHolder instanceof HTMLElement)
                return redactorInHolder;
        }
    ...
    getEditorHolder() {
        ...
        if (holder) {
            if (typeof holder === 'string') {
                ...
                if (holderElement instanceof HTMLElement)
                    return holderElement;
            }
            if (holder instanceof HTMLElement) {
                const wrapperInHolder = holder.querySelector(`.${this.EditorCSS.editorWrapper}`);
                if (wrapperInHolder instanceof HTMLElement)
                    return wrapperInHolder;
            }
        }
